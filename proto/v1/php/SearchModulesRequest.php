...
class SearchModulesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>uint64 min_size = 6;</code>
     */
    protected $min_size = null;
    /**
     * maximum size in bytes of the module
     *
     * Generated from protobuf field <code>uint64 max_size = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.SourceLanguage source_language = 9;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp inserted_before = 11;</code>
     */
    protected $inserted_before = null;
    /**
     * timestamp when this module was loaded and stored
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp inserted_after = 12;</code>
     */
     ...
     *
     * Generated from protobuf field <code>string function_name = 14;</code>
     */
    protected $function_name = null;
    /**
     * match on the module name e.g. `env` or `wasi_snapshot_preview1`
     *
     * Generated from protobuf field <code>string module_name = 15;</code>
     */
     ...
     *     @type string $hash
     *           original name of the binary module file
     *     @type \Import[]|\Google\Protobuf\Internal\RepeatedField $imports
     *           function imports called by the module (see:
     *           <https://github.com/WebAssembly/design/blob/main/Modules.md#imports>)
     *     @type \Export[]|\Google\Protobuf\Internal\RepeatedField $exports
     *           function exports provided by the module (see:
     *           <https://github.com/WebAssembly/design/blob/main/Modules.md#exports>)
     ...
     *
     * Generated from protobuf field <code>repeated .Import imports = 4;</code>
     * @param \Import[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Export exports = 5;</code>
     * @param \Export[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    {
        return isset($this->inserted_before) ? $this->inserted_before : null;
    }
    ...
    {
        return isset($this->inserted_after) ? $this->inserted_after : null;
    }
